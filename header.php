<nav class="navbar navbar-expand-md nav-responsive navbar-dark fixed-top">
    <div class="container main-nav">
        <a href="hello-home.php" class="navbar-brand text-uppercase fw-bold text-dark">
            <span class="bg-danger bg-gradient p-1 m-1 rounded-3 text-light">Hello </span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item ps-3">
                    ...
                    <a class="nav-link text-white"  data-bs-toggle="modal" data-bs-target="#staticBackdrop" style=" cursor: pointer;">Deconnexion</a>
                </li>
            </ul>
